...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-40 right-20 w-32 h-32 bg-white/10 rounded-full animate-float blur-md" style={{ animationDelay: '1s' }}></div>
      <div className="absolute top-1/3 right-10 w-16 h-16 bg-white/15 rounded-full animate-float blur-sm" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className="mb-16 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          <Button 
            className="hero-button text-lg px-8 py-6 rounded-full shadow-glow"
        ...
        <div className="flex justify-center gap-6 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
          <a 
            ...
            className="w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 hover:scale-110"
          >
